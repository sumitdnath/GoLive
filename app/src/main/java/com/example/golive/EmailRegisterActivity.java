...
public class EmailRegisterActivity extends AppCompatActivity {
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful())
                            {
                                ...
                                Toast.makeText(EmailRegisterActivity.this, "Account Created Successfuly..", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            }
                            else {
    ...
    private void SendUserToLoginActivity() {
        ...
        Intent loginIntent = new Intent(EmailRegisterActivity.this,LoginActivity.class);
        startActivity(loginIntent);
    }

    private void SendUserToMainActivity() {

        Intent mainIntent = new Intent(EmailRegisterActivity.this, MainActivity.class);
